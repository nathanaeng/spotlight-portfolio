        ...
        <div className="modal resume" id="resumeModal" tabIndex="-1" aria-labelledby="resumeModalLabel" aria-hidden="true">
            <div className={`modal-dialog modal-dialog-centered ${styles["modal-width"]}`}>
                <div className="modal-content">
                    ...
                    <a className={styles["close-modal"]} href="/" data-bs-dismiss="modal" aria-label="Close"><MdClose /></a>
                    <div className="modal-body">
                        <Resume scale={s}/>
                        <a className={styles["resume-download"]} href="/documents/Resume.pdf" download><FiDownload /></a>
                    </div>
